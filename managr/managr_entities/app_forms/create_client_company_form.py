...
class CreateClientCompanyForm(forms.Form):
    ...
    company_address = forms.CharField(max_length = 128, error_messages={'required': 'Address is required', 'max_length': 'The address given is too long'})
    company_city = forms.CharField(max_length = 128, error_messages={'required': 'City is required', 'max_length': 'The city given is too long'})
    company_state = forms.IntegerField(min_value = 0, max_value = 51, error_messages={'required': 'State is required'})
    company_postal_code = forms.CharField(error_messages={'required': 'Postal code is required'})
    company_description = forms.CharField(error_messages={'required': 'Company description is required'})
    ...
    def clean_company_postal_code(self):
